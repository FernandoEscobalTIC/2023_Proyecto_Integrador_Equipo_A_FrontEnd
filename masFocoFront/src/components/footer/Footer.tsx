    ...
    <footer>
      ...
      <div className="footer-bottom">
        ...
        <div className="social-media">
          <p>REDES SOCIALES:</p>
          <a href="https://facebook.com/masFoco" target="_blank" rel="noopener noreferrer">
            <img src={facebookLogo}
              alt="twitterLogo"
            />
          </a>
          <a href="https://twitter.com/masFoco" target="_blank" rel="noopener noreferrer">
            <img src={twitterLogo}
              alt="twitterLogo"
            />
          </a>
          <a href="https://www.instagram.com/masFoco" target="_blank" rel="noopener noreferrer">
        ...
        <div className="contact-info">
          ...
          <br />
          Dirección: <a href="https://maps.google.com/direccion" target="_blank" rel="noopener noreferrer">Calle Principal 123, Ciudad</a>
          <br />
